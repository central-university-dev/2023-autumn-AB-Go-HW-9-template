...
const (
	GreetingService_SayHello_FullMethodName = "/quotes.GreetingService/SayHello"
)

// GreetingServiceClient is the client API for GreetingService quotes.
//
...
// GreetingServiceServer is the server API for GreetingService quotes.
...
// UnsafeGreetingServiceServer may be embedded to opt out of forward compatibility for this quotes.
...
// GreetingService_ServiceDesc is the grpc.ServiceDesc for GreetingService quotes.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var GreetingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "quotes.GreetingService",
